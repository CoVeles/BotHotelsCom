...
PHRASES = {
    ...
    'wait': ('Wait please. Searching info...',
             'Подождите пожалуйста, идет поиск информации...'),
    ...
    'sel_dist': ('Select maximum distance from centre',
    ...
    'location': ('You selected location:',
                 'Вы выбрали локацию:'),
    'date': ('You selected date:',
             'Вы выбрали дату:'),
    ...
    'Tot_price': ('Total price for', 'Общая цена за'),
    'Days': ('days', 'дней'),
